...
import { IconBirthday, IconEmail, IconImage, IconPhone, IconUser } from './Icons';
...
function Octagon({ width, cardwidth, cardheight, cardbackground, imgwidth, imgheight }) {
  ...
  return (
    <CardWrap width={width}>
      <Card cardwidth={cardwidth} cardheight={cardheight} cardbackground={cardbackground}>
        <Top>
          <Img src={image} onClick={FileInput} imgwidth={imgwidth} imgheight={imgheight} />
          <ImgInput
            type="file"
            id='file-upload'
            accept="image/*"
          ...
          />
          <Button onClick={FileInput}><IconImage /></Button>
        </Top>
        <Buttom>
          <SmallBox>
            <IconUser />
